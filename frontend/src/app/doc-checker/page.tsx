...
import { Table, Modal, Card, Input, Button, Collapse } from 'antd';
    ...
    const fetchData = async () => {
      try {
        ...
        if (data.conversation) {
          ...
          const itemsArray = Object.keys(parsedData).map(key => ({
            content: parsedData[key].content,
            role: parsedData[key].role
          }));
          setItems(itemsArray);
        }
